...
class loginguru1 extends BaseController
{
    ...
    public function datanilai($id_kelas)
    {
        ...
        $data = [
            'title' => 'Nilai Siswa',
            'jadwal' => $this->ModelGr->DetailJadwal($id_kelas),
            'siswa' => $this->ModelGr->siswa($id_kelas),
    ...
    public function simpannilai($id_jadwal)
    {
        ...
        foreach ($siswa as $key => $value) {
            ...
            $quis = $this->request->getPost($value['id_krs'] . 'nilai_quis');
            $ketrampilan = $this->request->getPost($value['id_krs'] . 'nilai_ketrampilan');
            $kerajinan = $this->request->getPost($value['id_krs'] . 'nilai_kerajinan');
            ...
            $data = [
                'id_krs' => $this->request->getPost($value['id_krs'] . 'id_krs'),
                'nilai_quis' => $this->request->getPost($value['id_krs'] . 'nilai_quis'),
                'nilai_ketrampilan' => $this->request->getPost($value['id_krs'] . 'nilai_ketrampilan'),
                'nilai_kerajinan' => $this->request->getPost($value['id_krs'] . 'nilai_kerajinan'),
