...
class Ta extends BaseController
{
        ...
        if ($this->validate([
            'ta' => [
                ...
                'errors' => [
                    ...
                    // 'validateTaSemester' => '{field} sudah ada. Input Tahun Pelajaran lain dengan Semester yang berbeda!!',
    ...
    public function edit($id_ta)
    {
        ...
        if ($this->validate([
            'ta' => [
                'label' => 'Tahun Pelajaran',
                'rules' => 'required|is_unique[tbl_ta.ta,ta,{ta}]|regex_match[/^[0-9]{4}\/[0-9]{4}$/]',
                'errors' => [
                    'required' => '{field} wajib diisi!!!',
